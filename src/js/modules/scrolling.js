    ...
    let links = document.querySelectorAll('[href^="#"]'),
        ...
        links.forEach(link => {
            link.addEventListener('click', function(event) {
                ...
                // time автоматический аргумент, который самостоятельно приходит в функцию
                function step(time) {
                    if (start === null) {
                        start = time;
                    }
                    ...
                    // r - Отвечает за количество пикселей на которое нам необходимо пролистать в течение этой операции
                        ...
                        // анимация может двигатся вверх так : и в  низ

                        document.documentElement.scrollTo(0, r);
                        // скролим по определенным координатам (X, Y)
